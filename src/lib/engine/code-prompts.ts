...
- ACESSO E LOGIN: ao adicionar login, implemente signIn E signUp visíveis antes de usar coleções authenticated. Ao remover login, remova também me/signOut e troque dados administrativos/pessoais para profile:"private"; nunca deixe coleção authenticated sem caminho de entrada e nunca torne dados pessoais públicos.
